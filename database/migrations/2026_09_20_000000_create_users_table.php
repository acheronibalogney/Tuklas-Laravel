...
return new class extends Migration {
    public function up(): void {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('password'); $table->string('role')->default('user'); $table->string('status')->default('active');
            $table->string('workspace_id')->nullable()->index(); $table->jsonb('profile')->nullable(); $table->jsonb('analysis')->nullable();
            $table->jsonb('notifications')->nullable(); $table->jsonb('settings')->nullable(); $table->rememberToken(); $table->timestamps();
        });
